...
const Home = () => {
  return (
    ...
    <div class="flex items-center justify-center h-full text-center">
        ...
        <button type="button" class="bg-[#A78BFA] text-white border-none mr-5 m-2 px-2 py-2.5 rounded-2xl hover:bg-purple-700 active:bg-green-700 cursor-pointer">About Me</button>
        <button type="button" class="bg-[#A78BFA] text-white border-none ml-5 m-2 px-2 py-2.5 rounded-2xl hover:bg-purple-700 active:bg-green-700 cursor-pointer">Projects</button>
        </div>
        </div>
    </div>
    </>
