...
const Home = () => {
  return (
    <div class="flex items-center justify-center h-full text-center">
        ...
        <button type="button" class="bg-[#A78BFA] text-white border-none mr-5 m-2 px-2 py-2.5 rounded-2xl">About Me</button>
        <button type="button" class="bg-[#A78BFA] text-white border-none ml-5 m-2 px-2 py-2.5 rounded-2xl">Projects</button>
        </div>
        </div>
    </div>
  )
