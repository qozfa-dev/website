...
const Projects = () => {
  return (
    <section id="Projects" className="h-screen">
      ...
      <div className="grid-rows-3 flex justify-between items-center mt-20">

        <div className="bg-[#1F2937] max-w-50 min-h-65 justify-center items-center rounded-2xl cursor-pointer hover:scale-105 transition-transform duration-300 ease-in-out m-5">
